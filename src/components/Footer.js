    ...
    <footer className="footer">
      <div className="footer__wrap">
        ...
        <div className="footer__bottom">
          <div className="footer__bottom--linkList linkList">
            <ul className="linkList__wrap">
              ...
              <li className="linkList__item">
                <Link className="linkList__item--privacy" to={"/privacy"}>개인정보처리방침</Link>
              </li>
            </ul>
            <div className="linkList__snsList">
          ...
          <div className="footer__bottom--businessInfo businessInfo">
            <div className="business__info info-top">
              <span>크림 주식회사</span>
              <span>
            ...
            <div className="business__info info-bottom">
